<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FabricEntry.aspx.cs" EnableEventValidation="false" Inherits="admin_EntryPanel_FabricEntry" %>
            ...
            <div class="main">
                ...
                <div class="main-content" style="background-color:#E6E6E8">
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12" style="text-align:center; text-decoration: underline; text-transform: uppercase;letter-spacing: 3px;line-height: 1.8;font-family:Franchise;color:#13144F;">
                            <h1 >Fabric Entry Panel </h1>
                        </div>
                        <div class="col-lg-12">
                            <hr />
                        </div>
                        ...
                        <div class="col-lg-12" id="mainDiv">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-4">
                                    <asp:Label ID="FabricTypeLabel" runat="server" Text="Fabric Type" style="text-transform: uppercase;letter-spacing: 3px;line-height: 1.8;font-size:20px;font-weight: bold;color:#13144F;"></asp:Label>
                                    <asp:TextBox ID="fabricTypeTextBox" runat="server" Style="border: 2px solid #0099FF;color:black;" CssClass="form-control" placeholder="Fabric Type" ></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                                    <asp:Label ID="FabricNameLabel" runat="server" Text="Fabric Name" style="margin-left: 10%;text-transform: uppercase;letter-spacing: 3px;line-height: 1.8;font-size:20px;font-weight: bold;color:#13144F;"></asp:Label>
                                    <asp:TextBox ID="fabricNameTextBox" runat="server"  CssClass="form-control" placeholder="Fabric Name" style="margin-left: 10%;border: 2px solid #0099FF;color:black;"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                                    <asp:Button ID="submitButton" runat="server" Text="Submit" CssClass="btn btn-success" OnClick="submitButton_Click" style="margin-top: 34px;margin-left:20%;background-color: #008CBA;border-color:#008CBA;"/>
                                </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
