<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SampleStageEntry.aspx.cs" EnableEventValidation="false" Inherits="admin_EntryPanel_SampleStageEntry" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sample Stage</title>
                ...
                <div class="main-content" style="background-color:#E6E6E8">
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12" style="text-align:center; text-decoration: underline; text-transform: uppercase;letter-spacing: 3px;line-height: 1.8;color:#13144F;font-family:Franchise;">
                            <h1>Sample Stage Entry Panel </h1>
                        </div>
                        <div class="col-lg-12">
                            <hr />
                        </div>
                        ...
                        <div class="col-lg-12" id="mainDiv">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="usr" style="text-transform: uppercase;letter-spacing: 3px;line-height: 1.8;font-size:17px;font-weight: bold;margin-left:40%;color:#13144F;">Buyer Name</label>
                                        <asp:DropDownList ID="buyerNameDropDownList" runat="server" Style="width: 160px; margin-left:40%;border: 2px solid #0099FF;color:black;" CssClass="form-control">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-lg-3">

                                    <label for="usr" style="text-transform: uppercase;letter-spacing: 3px;line-height: 1.8;font-size:17px;font-weight: bold;margin-left: 60px;color:#13144F;">Sample Stage</label>
                                    <asp:TextBox ID="sampleStageTextBox" runat="server" CssClass="form-control" placeholder="Sample Stage" Style="width: 160px;margin-left:60px;border: 2px solid #0099FF;color:black;"></asp:TextBox>
                                </div>

                                <div class="col-lg-3">
                                    <label for="usr" style="text-transform: uppercase;letter-spacing: 3px;line-height: 1.8;font-size:17px;font-weight: bold;margin-left: 41px;color:#13144F;">IsActive</label>
                                    <asp:DropDownList ID="isAcctiveDropDownList" runat="server" Style="width: 160px;margin-left: 20%;border: 2px solid #0099FF;color:black;" CssClass="form-control">
                                 ...
                                 <div class="col-lg-3">
                                    <asp:Button ID="submitButton" runat="server" Text="Submit" Style="margin-top: 17%;margin-left: 16%;background-color: #008CBA;border-color:#008CBA;" CssClass="btn btn-success" OnClick="submitButton_Click" />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12" style="border: -19px solid #ddd; margin-left: 10%;width: 80%;" >
                                <%=table%>
                            </div>
                        </div>
...
<script type="text/javascript">
    function ddlValidate() {
        var e = document.getElementById("buyerNameDropDownList");
