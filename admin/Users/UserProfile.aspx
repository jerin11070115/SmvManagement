<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserProfile.aspx.cs" EnableEventValidation="false" Inherits="admin_Users_UserProfile" %>
...
<body>
    <form id="form1" runat="server">
        <div id="wrapper">
            ...
            <!-- END LEFT SIDEBAR -->
            <!-- MAIN -->
            <div class="main" style="background:#E6E6E8;">
                <!-- MAIN CONTENT -->
                <div class="main-content" style="background-color:#E6E6E8">
                    <div class="container-fluid">
                        <div class="col-lg-12">
                          <%--  <img src="../../assets/img/user-medium.png--%> <img src="../../assets/img/icons8-administrator-male-104%20(1).png" />
    <%-- alt="The head and torso of a dinosaur skeleton;
     ...
     title="A T-Rex on display in the Manchester University Museum">--%>
                        ...
                        <div class="col-lg-12" >
                            <h3><b> <asp:Label ID="fullNameLabel" runat="server"></asp:Label></b></h3>
                        </div>

                        <%--<div class="col-lg-12">
                            <div class="col-lg-4">
                                <asp:Label ID="costingStyleNumberLabel" runat="server" ></asp:Label>
                            </div>
                            <div class="col-lg-4">
                                <asp:Label ID="costingSampleStageLabel" runat="server" ></asp:Label>
                            </div>
                            <div class="col-lg-4">
                                <asp:Label ID="costingAvgLabel" runat="server" ></asp:Label>
                            </div>
                        </div>--%>
                        <%--<div class="col-lg-12">
                            <div class="col-lg-4">
                                <asp:Label ID="bulkStyleNumberLabel" runat="server" ></asp:Label>
                            </div>
                            <div class="col-lg-4">
                                <asp:Label ID="bulkSampleStageLabel" runat="server" ></asp:Label>
                            </div>
                            <div class="col-lg-4">
                                <asp:Label ID="bulkAvgLabel" runat="server" ></asp:Label>
                            </div>
                        </div>--%>
                        <div class="col-lg-12">
                            <h4><b>New costing Style : <%=styleTable%></b></h4>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <h4><b>Costing Revised : <%=sampleTable%></b></h4>
                        </div>
                        <%--<div class="col-lg-12 table table-bordered">
                             <%=sampleTable%>
                        </div>--%>
                        ...
                        <div class="col-lg-12">
                            <h4><b>New Bulk Style : <%=bulkStyleTable%></b></h4>
                        </div>
                        <%--<div class="col-lg-12 table table-bordered">
                             <%=bulkStyleTable%>
                        </div>--%>
                        ...
                        <div class="col-lg-12">
                            <h4><b>Bulk Revised : <%=bulkSampleTable%></b></h4>
                        </div>
                        <%--<div class="col-lg-12 table table-bordered">
                             <%=bulkSampleTable%>
                        </div>--%>
            ...
            <footer>
                <div class="container-fluid" style="background:#E6E6E8">
