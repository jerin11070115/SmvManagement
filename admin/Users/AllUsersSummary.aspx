<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllUsersSummary.aspx.cs" EnableEventValidation="false" Inherits="admin_Users_AllUsersSummary" %>
...
<body>
    <form id="form1" runat="server">
        <div id="wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="col-lg-12">
                            <div class="col-lg-4 form-group">
                                <asp:TextBox ID="fromDateTextBox" runat="server" PlaceHolder="From Date" style="background-color:#244369;color:#F1F1F1" CssClass="form-control" ></asp:TextBox>
                            </div>
                            <div class="col-lg-4 form-group">
                                <asp:TextBox ID="toDateTextBox" runat="server" PlaceHolder="To Date" style="background-color:#244369;color:#F1F1F1" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-lg-4 form-group">
                        ...
                        <div class="col-lg-12">
                            <h3 style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;">New Costing Info:</h3>
                        </div>
                       <div class="col-lg-12">
                             <%=newCostingTable%>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <h3 style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;">Revised Costing Info:</h3>
                        </div>
                        <div class="col-lg-12">
                             <%=RevisedCostingTable%>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <h3 style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;">New Bulk Info:</h3>
                        </div>
                       <div class="col-lg-12">
                             <%=newBulkTable%>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <h3 style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;" >Revised bulk Info:</h3>
                        </div>
                        <div class="col-lg-12">
                             <%=RevisedBulkTable%>
                        </div>
            ...
            <footer>
                <div class="container-fluid">
                    <p class="copyright">Kenpark & Regency (Hirdaramani Bangladesh) &copy; 2017</p>
                </div>
            </footer>
        </div>
    </form>
