<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DailyKpiReport.aspx.cs" EnableEventValidation="false" Inherits="admin_Users_DailyKpiReport" %>
                ...
                <div class="sidebar-scroll">
                    <nav>
                        <ul class="nav">
                            ...
                            <li><a href="../Users/DailyKpiReport.aspx" class="active"><i class="lnr lnr-map"></i><span>Daily KPI Report</span></a></li>
                    ...
                    <div class="container-fluid">
                        <div class="col-lg-12">
                            <div class="col-lg-4 form-group">
                                <asp:TextBox ID="fromDateTextBox" runat="server" PlaceHolder="From Date" style="background-color:#244369;color:white;" CssClass="form-control" ></asp:TextBox>
                            </div>
                            <div class="col-lg-4 form-group">
                                <asp:TextBox ID="toDateTextBox" runat="server" PlaceHolder="To Date" style="background-color:#244369;color:white;" CssClass="form-control" ></asp:TextBox>
                            </div>
                            <div class="col-lg-4 form-group">
                        ...
                        <div class="col-lg-12" style="text-align:center">
                            <h1 style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;">IE TEAM - Daily KPI Report</h1>
                        </div>
