...
public partial class admin_SMV_CostingRevisedPanel : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UpId = Convert.ToInt32(Request.QueryString["Up"]);
    ...
    public string loadCostingSmvinformation(int buyerId, string StyleNumber)
    {
        ...
        try
        {
            smvtable = smvBll.LoadCostingSmvInfoRevised(buyerId, StyleNumber);
        }
        catch (Exception ex)
        {
    ...
    public void LoadSmvInfoForRevised(int smvId)
    {
    ...
    public void ClearAllData()
    {
        ...
        //styleDropDownList.SelectedValue = "0";
    ...
    {
        Response.Redirect("CostingRevisedPanel.aspx");
    }
    ...
    protected void submitButton_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            smv.StyleNumber = styleNumberTextBox.Text;
            smv.DesignNumber = designTextBox.Text;
            ...
            smv.UpdatedBy = 0;
            dt = smvBLL.InsertCostingSmvInfo(smv, data);
    ...
    protected void exlButton_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Revised_Costing_Smv.xls");
        Response.Charset = "";
