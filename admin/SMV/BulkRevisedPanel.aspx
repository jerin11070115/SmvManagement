<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BulkRevisedPanel.aspx.cs" Inherits="admin_SMV_BulkRevisedPanel" EnableEventValidation="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Bulk Revised</title>
                    ...
                    <div id="navbar-menu">
                        <ul class="nav navbar-nav navbar-right">
                           <%-- <li class="dropdown">
                            ...
                            <button class="btn btn-primary" id="reloadButton" runat="server" style="background-color: #001f3f; border-color: #001f3f; margin-top: 24px;" href="../SMV/BulkRevisedPanel.aspx" ><span  class="glyphicon glyphicon-refresh"></span></button> 
                            <li class="dropdown">
                ...
                <div class="main-content" style="background-color: #F1F1F1">
                    <div class="container-fluid" >
                            ...
                            <div class="col-lg-11" style="text-align:center;">
                                <h1  style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;">Bulk Revised Information</h1>
                            </div>

                            
                                
                                <%--<asp:Button ID="reloadButton" runat="server" Text="Refresh"BackColor="#20B2AA" BorderColor="#000000" ForeColor="#FBFCFC" Font-Size="Small" OnClick="reloadButton_Click"  />--%>
                        ...
                        <div class="col-lg-4">
                            <asp:DropDownList ID="searchDropDownList" runat="server" Style="border-radius:15px;width: 200px;background-color:#244369;margin-left: 228px;color:#F1F1F1" CssClass="form-control">
                            </asp:DropDownList>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group" >
                                ...
                                <asp:TextBox ID="searchTextBox" runat="server" Style="border-radius:15px;width: 200px; margin-left: 200px;background-color:#244369;color:#F1F1F1" CssClass="form-control" placeholder="Search With Style Number"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-3" style="text-align: center">
                            <%--<asp:Button ID="searchButton" runat="server" Text="Search" BackColor="#2471A3" BorderColor="#000000" ForeColor="#FBFCFC" Font-Size="Small" CssClass="btn btn-success btn-search" OnClick="searchButton_Click"  />--%>
                        ...
                        <div class="col-lg-12" id="mainBody"  runat="server" style="background-color: #F1F1F1">
                            <div class="col-lg-12">
                           ...
                           <%--  <div class="col-lg-12" style="text-align: center; vertical-align:central; margin-bottom: 45px; background-color:#AAB7B8;">
                            <h1 style="color:#2471A3;">Bulk Revised Entry</h1>
                        </div>--%>
                            <div class="col-lg-12">
                                <hr />
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="sampleDateTextBox" runat="server"  Style="border-radius:15px;width: 190px;background-color:#244369;color:#F1F1F1" CssClass="form-control"  placeholder="Sample Date"></asp:TextBox>
                                </div>
                            </div>
...
<%--							<div class="col-lg-3">
                            ...
                            <div class="col-lg-12" id="smvBody">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="fitsTextBox" runat="server" style="border-radius:15px;background-color:#244369;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="overlayTextBox" runat="server" style="border-radius:15px;background-color:#244369;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="plkTextBox" runat="server" style="border-radius:15px;background-color:#244369;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="autoTextBox" runat="server" style="border-radius:15px;background-color:#244369;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <label for="quiltingManualTextBox" style="color:#2471A3;"><b>Manual :</b> </label>
                                        <asp:TextBox ID="quiltingManualTextBox" runat="server" style="border-radius:15px;background-color:#244369;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="downMachineTextBox" runat="server" style="border-radius:15px;background-color:#244369;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-lg-4" >
                                    <div class="form-group">
                            ...
                            <div class="col-lg-12" style="margin-top: 20px;">
                                <div class="col-lg-4">
                                    <asp:Button ID="submitButton" runat="server" Text="Revised" class="btn btn-success" Style="width: 89px; margin-left: 120px;background-color:#096887;border-color: #096887;"  OnClientClick="return Validation();" OnClick="submitButton_Click" />
                                </div>
                                <div class="col-lg-4">
                                    
                                </div>
                                <div class="col-lg-4">
                                    <asp:Button ID="updateButton" runat="server" Text="Correction" class="btn btn-success" Style="width: 100px; margin-left: 80px;background-color:#096887;border-color: #096887;" OnClick="updateButton_Click"/>
                                </div>
                            </div>
                          <div class="col-lg-12">
                                <hr />
