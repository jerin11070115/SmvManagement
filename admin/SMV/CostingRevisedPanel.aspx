<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CostingRevisedPanel.aspx.cs" EnableEventValidation="false" Inherits="admin_SMV_CostingRevisedPanel" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Costing Revised</title>
                    ...
                    <div class="container-fluid">
                         <div class="col-lg-12">
                            <div class="col-lg-11" style="text-align:center">
                                <h1 style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;">Costing Revised Information</h1>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-4" style="text-align: center;border-radius: 15px;">
                                <div class="form-group">
                                    <asp:DropDownList ID="searchDropDownList" Style="border-radius:15px; width: 75%; background-color:#244369;margin-left: 189px;color:#F1F1F1" runat="server"  CssClass="form-control">
                                    </asp:DropDownList>
                            ...
                            <div class="col-lg-4" style="text-align: center;width: 27%;">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="searchTextBox" runat="server" Style="border-radius: 20px; background-color:#244369;margin-left: 135px;color:#F1F1F1" CssClass="form-control" placeholder="Search With Style Or Design Number"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-4" style="text-align: center">
                               <div class="glyphicon">
                                <i class="glyphicon glyphicon-search form-control-feedback" style="color: #f5f0f0;"></i>
                                <asp:Button ID="Button1" runat="server" style="background-color: #12233C; border-color: #12233C;"  class="btn btn-primary btn-search" OnClick="searchButton_Click" />
                            </div>
                       ...
                       <%-- <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                           <%-- <div class="col-lg-11">
                                <h3 style="color:#001f3f;">Costing Revised Information</h3>
                            </div>--%>
                            <%--<div class="col-lg-1">
                        ...
                        <div class="col-lg-12" id="mainBody" runat="server">
                           ...
                           <div class="col-lg-3">
                            ...
                            <div class="col-lg-12" id="smvBody">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="cuttingTextBox" runat="server" style="background-color:#244369;border-radius: 22px;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="finisingTextBox" runat="server" style="background-color:#244369;border-radius: 22px;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="heatSealTextBox" runat="server" style="background-color:#244369;border-radius: 22px;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                    </div>
                                </div>
                                     <div class="col-lg-2">
                                    <div class="form-group">
                                        <label for="overlayTextBox" style="color:#2471A3;"><b>Overlay Film :</b> </label>
                                        <asp:TextBox ID="overlayTextBox" runat="server" style="background-color:#244369;border-radius: 22px;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                    </div>
                                </div>
                                     <div class="col-lg-2">
                                        <div class="form-group">
                                            <label for="downManualTextBox" style="color:#2471A3;"><b>Manual :</b> </label>
                                            <asp:TextBox ID="downManualTextBox" runat="server" style="background-color:#244369;border-radius: 22px;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="downMachineTextBox" runat="server" style="background-color:#244369;border-radius: 22px;color:#F1F1F1" CssClass="form-control" placeholder="00.00"></asp:TextBox>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <input id="addOption" type="button" value="ADD" onclick="AddOptions();" style="background-color:#096887;border-color: #096887;color:#F1F1F1" class="btn btn-success"/>
                            ...
                            <div class="col-lg-12" style="margin-top: 20px;">
                                <div class="col-lg-4">
                                    <asp:Button ID="submitButton" runat="server" Text="Revised" class="btn btn-success"  OnClientClick="return Validation();" Style="width: 120px; margin-left: 120px; background-color:#096887;border-color: #096887;" OnClick="submitButton_Click" />
                                </div>
                                <div class="col-lg-4">
                                    
                                </div>
                                <div class="col-lg-4">
                                    <asp:Button ID="updateButton" runat="server" Text="Correction" class="btn btn-success" Style="width: 120px; margin-left: 37px; background-color:#096887;border-color: #096887;" OnClick="updateButton_Click"/>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function PassData() {
        ...
        console.log(valueOfAllOption);
        $.ajax({
            type: 'post',
            url: 'CostingRevisedPanel.aspx/LoadJsonData',
