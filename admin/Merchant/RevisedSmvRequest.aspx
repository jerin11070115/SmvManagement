<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RevisedSmvRequest.aspx.cs" EnableEventValidation="false" Inherits="Merchant_RevisedSmvRequest" %>
...
<head>
    ...
    <style type="text/css">
        ...
        #buyerDropDownList, #styleNumberTextBox, #sampleStageDropDownList,#reasonToRevisedTextBox,#optionDropDownList, #nextSampleStageDropDownList, #fabricDropDownList, #productDropDownList, #quantityTextBox, #costingDeadLineTextBox, #commentsTextBox, #sendToDropDownList, #designNumberTextBox, #pdfFileUpload {
            margin-left: 15px;
            background: #cdcbcc;
            width: 30%;
        }

        #styleNumberTextBox, #fabricDropDownList, #productDropDownList, #quantityTextBox, #nextSampleStageDropDownList, #sendToDropDownList {
            margin-top: 20px;
            width: 30%;
        }
    ...
    <form id="form1" runat="server" class="cmxform">
        ...
        <div class="container">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
                ...
                <div class="row">
                    <asp:DropDownList ID="buyerDropDownList" runat="server" CssClass="form-control" onchange="sampleStageSelect(this.value);nextSampleStageSelect(this.value);"></asp:DropDownList>
                ...
                <div class="row">
                    <asp:DropDownList ID="sampleStageDropDownList" runat="server" CssClass="form-control">
                        <asp:ListItem Text="Please Select Previous Sample Stage" Value="0"></asp:ListItem>
                    </asp:DropDownList>
                ...
                <div class="row">
                    <asp:DropDownList ID="nextSampleStageDropDownList" runat="server" CssClass="form-control">
                        <asp:ListItem Text="Please Select Next Sample Stage" Value="0"></asp:ListItem>
                    </asp:DropDownList>
                    <asp:HiddenField ID="nextSampleStageHiddenField" Value="0" runat="server" />
                ...
                <div class="row">
                    <asp:TextBox ID="reasonToRevisedTextBox" runat="server" CssClass="form-control" placeholder="Reason To Revised"></asp:TextBox>
                </div>
...
<script type="text/javascript">
    ...
    function sampleStageSelect(intvalue) {
        ...
        //alert(categoryId);
        $('#sampleStageDropDownList').empty().append($("<option></option>").val("0").html("Please Select Previous Sample Stage"))
        $.ajax({
            beforeSend: function () {
            ...
            url: "RevisedSmvRequest.aspx/LoadSampleStage",
...
<script type="text/javascript">
    ...
    function nextSampleStageSelect(intvalue) {
        var buyerId = intvalue;
        //alert(categoryId);
        $('#nextSampleStageDropDownList').empty().append($("<option></option>").val("0").html("Please Select Next Sample Stage"))
        $.ajax({
            beforeSend: function () {
            ...
            success: function (data) {
                $.each(data.d, function (key, value) {
                    resultData = data['d'];
                    $("#nextSampleStageDropDownList").append($("<option></option>").val(value.SampleStageId).html(value.SampleStageName));  //value.resultData[0]
                    $('#nextSampleStageDropDownList').val($('#nextSampleStageHiddenField').val());
                });
            },
            error: function (result) {
                alert("Error");
    ...
    $('#nextSampleStageDropDownList').on('change', function () {

        $('#nextSampleStageHiddenField').val($('#nextSampleStageDropDownList').val());
