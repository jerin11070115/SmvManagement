<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SmvSentToMerchant.aspx.cs" EnableEventValidation="false" Inherits="admin_Request_SmvSentToMerchant" %>
                ...
                <div class="main-content" style="background-color:lavender">
                    <div class="container-fluid" >
                        ...
                        <div class="col-lg-12 row" style="text-align:center">
                            <h3> Send Data To Merchant </h3>
                        </div>
                        <div class="col-lg-12">
                            <hr />
                        </div>
                        <div class="col-lg-12">
                            <div id="fileUploadDiv row form-group">
                            ...
                            <div id="mailUploadDiv row form-group" style="margin-top:20px;">
                            ...
                            <div class="row form-group">
                                <asp:Button ID="sendButton" runat="server" Text="Send" CssClass="btn btn-success" OnClick="sendButton_Click" />
                            </div>
                        </div>
