<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ComponentSmvReport.aspx.cs" EnableEventValidation="false" Inherits="admin_Reports_ComponentSmvReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Component SMV Report</title>
                ...
                <div class="main-content"  style="background-color:#F1F1F1">
                    <div class="container-fluid">
                        <div class="col-lg-12" style="text-align: center">
                            <h1 style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;" >Component Smv Report</h1>
                        </div>
                        <div class="col-lg-12">
                            <hr />
                        </div>
                        <div class="col-lg-12">
                            <div class="col-lg-4">
                                <asp:DropDownList ID="buyerDropDownList" runat="server" CssClass="form-control" Style="width: 190px;background-color:#244369;margin-left: 250px;border-radius:22px;color:#F1F1F1">
                                </asp:DropDownList>
                                
                            </div>
                            <div class="col-lg-4">
                                <asp:TextBox ID="styleNumberTextBox" runat="server" CssClass="form-control" placeholder="Enter Style Number" Style="width: 190px;background-color:#244369;margin-left: 220px;border-radius:22px;color:#F1F1F1"></asp:TextBox>
                            </div>
                            <div class="col-lg-4">
                                <div class="glyphicon">
                                     <i class="glyphicon glyphicon-search form-control-feedback" style="color: #f5f0f0;"></i>
                                     <asp:Button ID="Button1" runat="server" style="background-color: #12233C; border-color: #12233C;margin-left: 90px;" class="btn btn-primary btn-search" OnClick="Button1_Click"></asp:Button>
