<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BulkSmvReport.aspx.cs" EnableEventValidation="false" Inherits="admin_Reports_BulkSmvReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Bulk Smv Reports</title>
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar-menu">
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="lnr lnr-question-circle"></i><span>Help</span><i class="icon-submenu lnr lnr-pointer-left"></i></a>
                ...
                <div class="main-content"  style="background-color:#F1F1F1">
                    <div class="container-fluid">
                        <div class="col-lg-12" style="text-align: center">
                            <h1 style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;margin-right: 160px;">Bulk Report</h1>
                        </div>
                        <div class="col-lg-12">
                            <hr />
                        </div>
                        <%--<div class="col-lg-12">--%>
                            <div class="col-lg-4">
                                <asp:DropDownList ID="buyerDropDownList" runat="server" CssClass="form-control" Style="border-radius:15px;width: 190px;background-color:#244369;margin-left: 200px;color:#F1F1F1">
                                </asp:DropDownList>
                                
                            </div>
                            <div class="col-lg-4">
                                <asp:TextBox ID="styleNumberTextBox" runat="server" CssClass="form-control" placeholder="Enter Style Number" Style="border-radius:15px;width: 190px;background-color:#244369;margin-left: 110px;color:#F1F1F1"></asp:TextBox>
                            </div>
                            <div class="col-lg-4">
                                <div class="glyphicon">
                                     <i class="glyphicon glyphicon-search form-control-feedback" style="color:#f5f0f0;"></i>
                                <asp:Button ID="Button1" runat="server" style="background-color:#12233C;border-color:#12233C;" class="btn btn-primary btn-search"  OnClick="Button1_Click"></asp:Button>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-3">
                                <asp:Button ID="exlbutton" runat="server" Text="Convert to Excel File" BackColor="#145A32" BorderColor="#145A32"  ForeColor="#FBFCFC" Font-Size="Small" CssClass="btn btn-success" OnClick="exlbutton_Click" />
