<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StyleCombineReport.aspx.cs" EnableEventValidation="false" Inherits="admin_Reports_StyleCombineReport" %>
...
<body>
    <form id="form1" runat="server">
        <div id="wrapper">
                ...
                <div class="main-content" style="background-color:#F1F1F1">
                    <div class="container-fluid" >
                        ...
                        <div class="col-lg-12 row" style="text-align:center">
                            <h1 style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;"> Style Combine Reports </h1>
                        </div>
                        <div class="col-lg-12">
                            <hr />
                        </div>
                        ...
                        <div id="searchArea" class="col-lg-12">
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-3">
                                    <asp:DropDownList ID="buyerDropDownList" runat="server" Style="background-color:#244369;border-radius: 22px;margin-left: 212px;color:#F1F1F1" CssClass="form-control" >

                                    </asp:DropDownList>
                                </div>

                                <div class="col-lg-3">
                                    <asp:TextBox ID="styleNumberTextBox" runat="server" Style="background-color:#244369;border-radius: 22px;margin-left: 200px;color:#F1F1F1" CssClass="form-control"  placeholder="Search With Style Number"></asp:TextBox>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <asp:Button ID="searchButton" runat="server" Text="search" style="margin-left: 211px;" CssClass="btn btn-success" OnClick="searchButton_Click" />
                                </div>
                            </div> 
                        ...
                        <div class="col-lg-3">
                            <asp:Button ID="exlbutton" runat="server" Text="Convert to Excel File" BackColor="#145A32" BorderColor="#000000" ForeColor="#FBFCFC" Font-Size="Small" CssClass="btn btn-success" OnClick="exlbutton_Click" />
            ...
            <footer>
                <div class="container-fluid">
                    <p style="color:#000000; font-family: "Helvetica Neue",Helvetica,Arial,sans-serif; font-weight: bold;" class="copyright">Kenpark & Regency (Hirdaramani Bangladesh) Ltd &copy; 2017</p>
                </div>
            </footer>
        </div>
    </form>
