<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BulkSmvDetailsReport.aspx.cs" EnableEventValidation="false" Inherits="admin_Reports_BulkSmvDetailsReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Bulk Smv Details Reports</title>
                ...
                <div class="main-content" style="background-color:#F1F1F1">
                    <div class="container-fluid">
                        <div class="col-lg-12" style="text-align: center">
                            <h1 style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;">Bulk Details Report</h1>
                        </div>
                        <div class="col-lg-12">
                            <hr />
                        </div>
                        <div class="col-lg-12">
                            <div class="col-lg-4">
                                <asp:DropDownList ID="buyerDropDownList" runat="server" CssClass="form-control" Style="border-radius: 22px;width: 190px;background-color:#244369;color:#F1F1F1">
                                </asp:DropDownList>
                                
                            </div>
                            <div class="col-lg-4">
                                <asp:TextBox ID="styleNumberTextBox" runat="server" CssClass="form-control" placeholder="Enter Style Number" Style="border-radius: 22px;width: 190px;background-color:#244369;color:#F1F1F1"></asp:TextBox>
                            </div>
                           <%-- <div class="col-lg-4">
                                <div class="glyphicon">
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-3">
                                <asp:Button ID="exlbutton" runat="server" Text="Convert to Excel File" BackColor="#145A32" BorderColor="#000000" ForeColor="#FBFCFC" Font-Size="Small" CssClass="btn btn-success" OnClick="exlbutton_Click1" />
