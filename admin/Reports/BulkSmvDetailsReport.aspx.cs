...
public partial class admin_Reports_BulkSmvDetailsReport : System.Web.UI.Page
{
    ...
    public string LoadBulkSmvReport(int buyerId, string styleNumber)
    {
        ...
        try
        {
            bulkTable = bulkBll.LoadBulkSmvLogReports(buyerId, styleNumber);
        }
        catch (Exception ex)
        {
    ...
    protected void exlbutton_Click1(object sender, EventArgs e)
    {
        DataTable dt = null;
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Bulk_Smv_Details_Report.xls");
        Response.Charset = "";
