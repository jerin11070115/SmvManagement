<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CostingSmvDetailsReport.aspx.cs" EnableEventValidation="false" Inherits="admin_Reports_CostingSmvDetailsReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Costing Smv Details Reports</title>
                ...
                <div class="main-content" style="background-color:#F1F1F1">
                    <div class="container-fluid" >
                        <div class="col-lg-11" style="text-align:center">
                            <h1 style="color:#13144F;display:inline-block; border-bottom:1px solid #13144F;font-family:Franchise;"> Costing Smv Details Reports </h1>
                        </div>
                        <div class="col-lg-12">
                            <hr />
                        </div>
                        ...
                        <div id="searchArea" class="col-lg-12">
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-4">
                                    <asp:DropDownList ID="buyerDropDownList" runat="server" Style="width: 190px;background-color:#244369;color:#F1F1F1" CssClass="form-control" >

                                    </asp:DropDownList>
                                </div>

                                <div class="col-lg-4">
                                    <asp:TextBox ID="styleNumberTextBox" runat="server" CssClass="form-control" Style="width: 190px;background-color:#244369;color:#F1F1F1" placeholder="Enter Style Number"></asp:TextBox>
                                </div>
